...
import { CommentArticleInput, DeleteCommentInput, GetCommentsInput } from "../schemas/interaction_schema.js";
import { CommentArticleRequest, DeleteCommentRequest, GetCommentsRequest, LikeArticleRequest, RevokeLikeRequest } from "../grpc/interactions/types.js";
...
export const makeCommentArticleController = (client: InteractionGrpcClient, executeCall: ExecuteCall) => {
    return async (req: Request<ArticleIdInput, {}, CommentArticleInput>, res: Response) : Promise<void> => {
        ...
        res.status(200).json({ success: response.success, postedAt: response.posted_at });
    }
}
